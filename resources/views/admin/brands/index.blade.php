...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dánh sách Brand</h1>
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        @foreach($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.brands.edit', $item) }}" class="btn btn-info mt-2">Edit</a>

                                    <form action="{{ route('admin.brands.delete', $item) }}" method="post">
                                        @csrf
                                        @method('DELETE')
